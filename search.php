	 ...
	 ?>
		...
		<div class='container_wrap container_wrap_first main_color <?php avia_layout_class( 'main' ); ?>'>
			...
			<div class='container'>
				...
				<main style="padding-top:35px !important;" class='search_page content template-search <?php avia_layout_class( 'content' ); ?> units' <?php avia_markup_helper(array('context' => 'content'));?>>
